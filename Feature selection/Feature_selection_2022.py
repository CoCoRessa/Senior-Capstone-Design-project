...
df_2022 = pd.read_csv('C:/Users/JunYeong.DESKTOP-IOMT4HU/Desktop/vscode/Feature selection/Feature_selection_data/Enterprise Survey/bgd_2022_rev.csv', encoding='utf-8')

df_merge = pd.read_csv('C:/Users/JunYeong.DESKTOP-IOMT4HU/Desktop/vscode/Feature selection/Feature_selection_data/Enterprise Survey/df_2022(4).csv')
...
df_common.drop([161,162,164], axis=0, inplace=True)

df_Boost_increase = pd.read_csv('C:/Users/JunYeong.DESKTOP-IOMT4HU/Desktop/vscode/Feature selection/Feature_selection_data/Boost/Boost_increase_FY14-20_L2.csv')
df_Boost_increase_pop = pd.read_csv('C:/Users/JunYeong.DESKTOP-IOMT4HU/Desktop/vscode/Feature selection/Feature_selection_data/Boost/Boost_increase_per_pop_FY14-20_L2.csv')
df_Boost_sum = pd.read_csv('C:/Users/JunYeong.DESKTOP-IOMT4HU/Desktop/vscode/Feature selection/Feature_selection_data/Boost/Boost_sum_FY14-20_L2.csv')
df_Boost_sum_pop = pd.read_csv('C:/Users/JunYeong.DESKTOP-IOMT4HU/Desktop/vscode/Feature selection/Feature_selection_data/Boost/Boost_sum_per_pop_FY14-20_L2_.csv')
...
df_ntl_increase = pd.read_csv('C:/Users/JunYeong.DESKTOP-IOMT4HU/Desktop/vscode/Feature selection/Feature_selection_data/Economic census/NTL_increase-2022.csv')

df_road_2022 = pd.read_csv('C:/Users/JunYeong.DESKTOP-IOMT4HU/Desktop/vscode/Feature selection/Feature_selection_data/Economic census/road_info_L3.csv')
df_road_2022 = df_road_2022[['L3_CODE', 'FY2020_road_lng_km', 'length_per_road_2020']]

df_merge.drop(['l6', 'd2', 'l1'], axis=1, inplace=True)

df_common = df_common[df_common['process']!='Null']
df1 = df_2022[df_common['Qcode']]
...
econ_list = ['Manu_emp_growth','Elec_emp_growth','Const_emp_growth','Hotel_emp_growth','Trans_emp_growth','Finan_emp_growth'	
             ,'Estate_emp_growth','Public_emp_growth','Edu_emp_growth','FY2017_SPC_NTL', 'NTL_value_2021', 'increase_NTL','FY2020_road_lng_km', 'length_per_road_2020']
...
df_population = pd.read_csv('C:/Users/JunYeong.DESKTOP-IOMT4HU/Desktop/vscode/Feature selection/Feature_selection_data/Economic census/zila_urbanization_2022.csv')
df_population = df_population[['MEMBER_Total', 'L2_CODE', 'urbanization', 'Urban_MEMBER']]

rest_list.append('MEMBER_Total')
rest_list.append('urbanization')
rest_list.append('Urban_MEMBER')
...
obstacle_list = ['c30a', 'd30a', 'd30b', 'e30', 'g30a', 'i30', 'k30', 'j30a', 'j30b', 'j30c', 'j30e', 'j30f', 'h30', 'l30a', 'l30b', 'BGDd30c']
for j in obstacle_list:
    df_merge_rev[j].replace({'No obstacle': 0, 'Minor obstacle':1, 'Moderate obstacle':1, 'Major obstacle':1, 'Very severe obstacle':1}, inplace=True)
...
drop_list = ['L1_CODE', 'L2_CODE','L2_NAME', 'L3_CODE', 'L3_NAME','d2', 'l1', 'z1_log', 'x1', 'l6', 'Rank','a2','a3a','a4a','a6a',
             'idstd', 'lat_mask', 'lon_mask', 'a0' , 'l5a', 'l5b', 'b6', 'b2d','b6', 'c9b','l3a', 'l3b']
...
df_merge_rev['a6b'].replace({'Micro': 'SME', 'Small':'SME', 'Medium':'SME'}, inplace=True)
...
#df_merge_rev['h1'].replace({'Yes': 1, 'No': 2}, inplace=True)
#df_merge_rev['h5'].replace({'Yes': 1, 'No': 2}, inplace=True)
#df_merge_rev['h_innovation'] = df_merge_rev['h1'] + df_merge_rev['h5']
#df_merge_rev['h_innovation'].replace({0: np.nan, 1:1, 2:1, 3:1, 4:0}, inplace=True)
#nominal_list.append('h_innovation')

df_merge_rev['l_female'] = (df_merge_rev['l5a'] + df_merge_rev['l5b']) / df_merge_rev['x1']
rest_list.append('l_female')
...
df_merge_rev = pd.merge(df_merge_rev, df_road_2022, how='left', left_on='L3_CODE', right_on='L3_CODE')
df_merge_rev = pd.merge(df_merge_rev, df_population, how='left', left_on='L2_CODE', right_on='L2_CODE')
...
for i in [0.9, 0.95, 0.97, 0.99]:
    ...
    shap_archive.to_csv('ratio_feature selection %s_2022.csv'%i)
    
for i in [1, 3, 5, 10]:
    shap_archive = rfe(X_features, y_target, 'shap', i)
    shap_archive.to_csv('ratio_feature selection_num %s_2022.csv'%i)
...
for i in [1, 3, 5, 10]:
    ...
    shap_archive.to_csv('append_feature selection_num %s_2022.csv'%i)    